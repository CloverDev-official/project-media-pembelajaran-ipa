...
<body>
                ...
                <header>
                    <nav class="flex justify-between gap-5">
                        <div class="flex flex-col text-start">
                            <h1 class="text-lg md:text-3xl font-bold  capitalize">edit latihan</h1>
                ...
                <main class="mt-5 mb-20">
                    <div class="bg-white p-4 rounded-lg shadow">
                        <div id="formPengaturan">
                            ...
                            <!-- jumlah soal -->
                            <div class="mb-4">
                                <label class="block font-semibold mb-1">Jumlah Soal (maks. 25):</label>
                                <input type="number" id="jumlahSoal" min="1" max="25" placeholder="contoh: 10" class="w-full border p-2 rounded-lg">
                            </div>
                            <!-- kelas -->
                            <div class="mb-4">
    ...
    <script src="../script/editLatihan.js"></script>
</body>
</html>