<main class="min-h-screen bg-subtle">
    ...
    <div class="bg-main-dark relative">
        ...
        <div class="flex justify-between items-center h-[89vh] relative z-10">
            <div class="mx-10 ">
                <h1 class="capitalize text-white font-bold text-shadow-sm text-3xl mb-2">Pelajari
                    dunia Ilmu Pengetahuan Alam</h1>
                <h1 class="text-6xl text-blue-500 text-shadow-2xs font-extrabold uppercase">
                    ipa<span class="text-yellow-400">verse</span></h1>
                <a href="materi.php" class="flex justify-start items-center mt-8">
                    <button
                        class="px-5 py-3 rounded-3xl font-semibold text-white text-xl bg-main transition-all duration-150 hover:scale-105 active:scale-95">
                        Mulai Belajar
                    </button>
                </a>
            </div>
        ...
        <div class="flex flex-col items-center mt-32 px-4">
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="hidden md:flex flex-wrap justify-center gap-6 mb-5">
                    <!-- bab 1 -->
                    <div
                        class="bg-main border-t border-r border-main-dark active:translate-x-[-13.5px] active:bg-green-600 text-white active:text-gray-200 hover:scale-[1.02] transition-all border-l-[6px] border-b-[6px] active:border-l active:border-b active:scale-95 rounded-tl-xl rounded-tr-3xl rounded-bl-xl rounded-b-lg w-72 relative">
                        <!-- nomer bab -->
                        <div
                            class="absolute  bg-main p-1 rounded-tl-md rounded-br-md text-shadow-2xs ">
                    ...
                    <div
                        ...
                        <div class="p-3">
                            ...
                            <p class="text-sm">Lakukan eksperimen dasar untuk memahami Fisika.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper mb-10 flex ">
                            ...
                            <div class="swiper-slide">
                                <div class="flex justify-center">
                                    <div
                                        class="bg-main border-t border-r border-main-dark border-l-[6px] border-b-[6px] rounded-tl-xl rounded-tr-3xl rounded-b-lg w-64 mx-auto relative text-white text-shadow-sm transition-all duration-150 active:border-[1px] active:scale-95 active:translate-x-[-13.5px] active:translate">
                                        <div
                                            class="absolute bg-main p-1 rounded-tl-sm rounded-br-md ">
                                            <p class="text-sm">Bab 1</p>
                                        </div>
                                        <div
                                            class="bg-gray-200 h-64 rounded-tl-md rounded-tr-3xl rounded-bl-3xl">
                                        </div>
                                        <div class="p-3 ">
                                            <h1 class="font-semibold text-xl ">Fisika Dasar</h1>
                                            <p class="text-sm">Jelajahi Konsep dasar dalam ilmu
                                                Fisika.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide ">
                                <div class="flex justify-center">
                                    <div
                                        ...
                                        <div class="p-3 ">
                                            <h1 class="font-semibold text-xl">Fisika Lanjutan
                                            </h1>
                                            <p class="text-sm">Pelajari hukum-hukum lanjutan
                                                dalam Fisika.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide ">
                                <div class="flex justify-center">
                                    ...
                                    <div
                                        ...
                                        <div class="p-3 ">
                                            <h1 class="font-semibold text-xl">Eksperimen</h1>
                                            <p class="text-sm">Lakukan eksperimen dasar untuk
                                                memahami Fisika.</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- chart -->
    <div
        class="bg-main flex flex-col lg:flex-row justify-center  gap-10 lg:gap-52 mt-20 p-4 lg:py-8">
        <!-- Progres Pembelajaran -->
        <div class="flex justify-center ">
            <div class="w-full max-w-md ">
                <h1 class="font-bold text-2xl lg:text-3xl text-white text-shadow-2xsl">Progres
                    Pembelajaran </h1>
                <p class="mt-4">Pantau Terus Pencapaian Kamu!</p>
                <div class="flex flex-col sm:flex-row gap-5 mt-10">
                    <div
                        class="bg-white border border-l-4 border-b-4  rounded-md p-4 border-gray-300 flex-1">
                        <p class="text-gray-700">Pembelajaran yang selesai</p>
                        <p class="font-semibold text-2xl">12</p>
                    </div>
                    <div
                        class="bg-white border border-l-4 border-b-4  border-gray-300 rounded-md p-4 flex-1">
        ...
        <div class="flex justify-center">
            <div class=" w-full max-w-md">
                <h1 class="font-bold text-2xl lg:text-3xl text-white text-shadow-2xs">Nilai
                    Seiring Waktu <i class="bi bi-bar-chart-fill"></i></h1>
                <p class="mt-2">Pantau perkembangan nilai kamu setiap ujian!</p>
                <div
                    class="bg-white mt-10 border border-l-4 border-b-4 border-gray-300 rounded-md p-4">
                    <!-- atur ukuran manual -->
    ...
    <div class="p-4">
        ...
        <div class="flex flex-col items-center mt-32 mb-10 px-4" id="jelajahi">
            <div class="text-center mb-10">
                <div class="text-5xl"><i
                        class="bi bi-search text-shadow-2xs text-shadow-gray-500 text-main"></i>
                </div>
                <h1
                    class="font-bold text-3xl sm:text-4xl mt-2 text-shadow-2xs text-main text-shadow-green-900">
                    Jelajahi Topik</h1>
                <p class="text-sm text-gray-700 mt-5">Pilih subjek untuk dipelajari lebih
                    dalam.</p>
            </div>
            <div class="flex flex-wrap justify-center gap-6">
                <!-- topik 1 -->
                <div
                    class="bg-white border-b-4 border-l-4 transition-all hover:bg-gray-100 active:bg-gray-100 active:scale-95 active:translate-x-[-13.5px] active:border-[1px]  flex flex-col sm:flex-row gap-5 border border-main-dark p-5 md:w-[25rem] w-[18rem]  rounded-md ">
                    <div class="w-20 h-20 bg-gray-500"></div>
                    <div>
                        <h1
                            class="font-bold text-xl text-main text-shadow-2xs text-shadow-green-700">
                            Physics Basics</h1>
                        <p class="text-sm text-gray-700">Understanding the world around us</p>
                        <div class="wrap-anywhere">
                            <p class="text-md font-semibold text-main">From motion to energy
                                transformations...</p>
                        </div>
