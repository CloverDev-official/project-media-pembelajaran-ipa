       ...
       <div class="absolute left-24">
            <div class="relative flex items-center gap-20">
                <div>
                    ...
                    <h1 class="mt-16 w-[40rem] text-3xl text-white">Pelajari ilmu pengetahuan alam dengan cara mudah dan menyenangkan bersama</h1>
                ...
                <div class="hidden md:flex flex-wrap justify-center gap-6 mb-5">
                    ...
                    @for($i = 1; $i <= 3;$i++) 
                        <div
                            ...
                            <!-- img card materi -->
                            <div class="bg-blue-500 h-72 rounded-tl-md rounded-tr-3xl rounded-bl-3xl">
                            </div>
                            <!-- judul card materi -->
                            <div class="p-3  text-shadow-2xs">
                                <h1 class="font-bold text-xl">Fisika Dasar</h1>
                                <p class="text-sm font-normal">Jelajahi Konsep dasar dalam ilmu Fisika.</p>
                            </div>
                        </div>
                    @endfor
                </div>                
