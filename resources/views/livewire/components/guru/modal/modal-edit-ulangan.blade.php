...
<div x-data="{ open: @entangle('showModal').live }" x-show="open" id="modalTambah"
    ...
    <div class="relative z-10 bg-white rounded-xl shadow-lg w-[90%] max-w-3xl flex flex-col">
        ...
        <div class="p-6 border-b text-center">
            <h2 class="text-2xl font-semibold capitalize">Edit Ulangan</h2>
            <p class="text-gray-500 text-sm capitalize">Edit ulangan baru di sini</p>
        </div>

        <!-- FORM MULAI -->
        <form id="formTambah" wire:submit.prevent="update" class="flex flex-col flex-1">
            <!-- Bagian scrollable -->
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="kelas" wire:model.defer="kelasId"
                            ...
                            @forelse ($daftarKelas as $kelas)
                                <option value="{{ $kelas->id }}">Kelas {{ $kelas->kelas }}
                                </option>
                            @empty
