     ...
     <div class="relative bg-white rounded-lg shadow-md p-6 z-10 w-80 md:w-96">
         <div class="flex flex-col mb-4 text-start">
             ...
             <p class="font-normal text-gray-400 text-sm capitalize">apakah anda yakin ingin
                 menyimpan materi ini?</p>
         </div>

         <form id="formHapus" class="flex flex-col gap-4" wire:submit.prevent="confirmSave">
             <div class="flex justify-between gap-2 mt-4">
                 <button wire:click='close' type="button" id="btnCloseHapus"
                     class="px-4 py-2 bg-red-500 text-white rounded-lg transition-all duration-150 hover:bg-red-600 hover:scale-105 active:scale-95">Tidak</button>
                 <button type="submit"
