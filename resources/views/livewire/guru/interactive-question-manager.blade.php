<div class="p-6">
    <div class="mb-6">
        ...
        <a href="{{ route('guru.interactive-video') }}" class="text-blue-600 hover:text-blue-800 text-sm">← Kembali ke daftar video</a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <form wire:submit.prevent="addQuestion" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Waktu Muncul (detik)</label>
                    <input 
                        type="number" 
                        wire:model="newQuestion.time_marker" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input 
                        type="text" 
                        wire:model="newQuestion.option_a" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        wire:model="newQuestion.option_b" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        wire:model="newQuestion.option_c" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        wire:model="newQuestion.option_d" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex justify-between items-start mb-2">
                        <div>
                            ...
                            <h4 class="font-medium text-gray-800 mt-1">{{ $question['question'] }}</h4>
                        </div>
                        <button 
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        <div class="flex items-center">
                            <span class="font-semibold mr-2 @if($question['correct_answer'] === 'a') text-green-600 @endif">A.</span>
                            <span>{{ $question['option_a'] }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="font-semibold mr-2 @if($question['correct_answer'] === 'b') text-green-600 @endif">B.</span>
                            <span>{{ $question['option_b'] }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="font-semibold mr-2 @if($question['correct_answer'] === 'c') text-green-600 @endif">C.</span>
                            <span>{{ $question['option_c'] }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="font-semibold mr-2 @if($question['correct_answer'] === 'd') text-green-600 @endif">D.</span>
