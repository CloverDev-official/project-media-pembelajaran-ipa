<div>
    <div class="container mx-auto px-4 py-6">
        <div class="p-6 bg-white rounded-xl shadow-lg">
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-gray-800">Video Interaktif</h2>
                ...
                <form wire:submit.prevent="saveVideo" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div wire:loading wire:target="thumbnailFile" class="mt-3 text-sm text-gray-500">
                                Uploading thumbnail...
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div wire:loading wire:target="videoFile" class="mt-3 text-sm text-gray-500">
                            Uploading video...
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end">
                        ...
                        >
                            <span wire:loading.remove wire:target="saveVideo" class="flex items-center">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-gray-100">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold text-gray-800">Daftar Video</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white border border-l-4 border-b-4 border-gray-300 p-2 rounded-lg min-w-[15rem] shadow">
                            ...
                            <div class="flex justify-center">
                                @if($video->thumbnail_path)
                                    <img 
                                        src="{{ Storage::url($video->thumbnail_path) }}" 
                                        alt="{{ $video->title }}" 
                                        class="bg-gray-200 w-full h-[12rem] rounded-lg border-0 object-cover">
                                @else
                                    <div class="bg-gray-200 w-full h-[12rem] rounded-lg border-0 flex items-center justify-center">
                            ...
                            <!-- judul dan deskripsi -->
                            <div class="mb-3 py-2">
                                <h2 class="font-bold text-main text-lg capitalize">{{ $video->title }}</h2>
                                @if($video->description)
                                    <p class="font-normal text-xs text-gray-600 mt-1">{{ $video->description }}</p>
                                @else
                                    <p class="font-normal text-xs text-gray-600 mt-1">Tidak ada deskripsi</p>
                                @endif
                            </div>
                            ...
                            <a
                                wire:navigate
                                href="{{ route('guru.interactive-question-manager', ['video' => $video->id]) }}"
                    ...
                    @empty
                        <div class="col-span-full text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload video interaktif pertamamu untuk memulai.</p>
                        </div>
                    @endforelse
                </div>
            </div>
