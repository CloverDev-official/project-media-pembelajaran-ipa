...
<div id="sidebar-container">
    ...
    <button id="sidebarButton" onclick="toggleSidebar()"
        class="fixed right-0 transition-transform duration-300 top-1/2 -translate-y-1/2 z-9 bg-green-600 text-white px-3 py-2 rounded-l-lg shadow-lg  hidden">
    ...
    <div id="sidebar"
        ...
        <div class="p-3 flex flex-col gap-2 ">
            <a href="../view/bab1.php#pengertian" class="hover:bg-green-100 p-2 rounded">1. Pengertian Pertumbuhan dan
                Perkembangan</a>
            <a href="../view/bab1.php#subBabPertama" class="hover:bg-green-100 p-2 rounded">A. Pertumbuhan dan Perkembangan pada
                Manusia</a>
            <a href="#3" class="hover:bg-green-100 p-2 rounded">B. Pertumbuhan dan Perkembangan
                Hewan</a>
