        ...
        <div id="sidebar" class="lg:w-2/12 fixed top-0 left-0 min-h-screen  bg-green-500 p-4 rounded-r-3xl shadow-2xl transform transition-transform duration-300 ease-in-out -translate-x-full  flex flex-col justify-between">
            ...
            <div>
                ...
                <ul class="mt-3 flex flex-col gap-5 text-white text-xl font-semibold capitalize">
                    <li>
                        <a href="../panelGuru/index.php" class="bg-green-700 pl-3 py-3 rounded-lg relative">
